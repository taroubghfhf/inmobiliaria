...
public class Bodega extends Propiedad {
    ...
    public boolean registrarBodega() {
        try{
            ...
            PreparedStatement st2 = con.prepareStatement("INSERT INTO propiedad (id, direccion, disponible, precio, fecha_creacion, area, unidades_area, disposicion_propiedad, id_bodega) VALUES(?,?,?,?,?,?,?,?,?)");
