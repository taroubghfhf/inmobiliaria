...
public class Parqueadero extends Propiedad{
    ...
    public boolean registrarParqueadero() {
        try{
            ...
            PreparedStatement st2 = con.prepareStatement("INSERT INTO propiedad (id, direccion, disponible, precio, fecha_creacion, area, unidades_area, disposicion_propiedad, id_parqueadero) VALUES(?,?,?,?,?,?,?,?,?)");
